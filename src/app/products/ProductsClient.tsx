...
export default function ProductsClient({ products, brands, categories }: ProductsClientProps) {
  ...
  return (
    <div style={{ maxWidth: 1280, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: '#111827', margin: 0 }}>Sản phẩm Pickleball</h1>
      </div>
